...
{
    /*
     * The aim of this class is to include a binding convention so that binding in Caliburn.Micro works.
    ...
    public static class PasswordBoxHelper
    {
        ...
        {
            if (!(d is PasswordBox box)) return (string) d.GetValue(BoundPasswordProperty);
        ...
        private static void PasswordChanged(object sender, RoutedEventArgs e)
        {
            ...
            password.GetType().GetMethod
            (
                "Select", BindingFlags.Instance | BindingFlags.NonPublic)?.Invoke(
