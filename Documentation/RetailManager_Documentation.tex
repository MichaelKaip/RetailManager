...
\boxed{\includegraphics[scale=0.69]{pic68}}
\newpage
...
\boxed{\includegraphics[scale=0.65]{pic69}}\\\\

\item Adding a UserModel class\\\\
\boxed{\includegraphics[scale=0.65]{pic70}}\\\\
\newpage

\item Adding the UserData class\\\\
\boxed{\includegraphics[scale=0.65]{pic71}}
\end{enumerate}
...
\boxed{\includegraphics[scale=0.69]{pic73}}\\\\
Implementing a method to get the Id from logged in users:\\\\
\boxed{\includegraphics[scale=0.69]{pic74}}\\\\
